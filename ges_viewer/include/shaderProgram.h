...
public:
    ...
    void SetUniformRaw(int loc, const glm::ivec2& value) const;
    ...
    void SetTex2D(std::string name, int tex, int index) const;
    void SetTex2DMS(std::string name, int tex, int index) const;
